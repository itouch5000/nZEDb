...
$moviecats = $cat->getChildren(Category::MOVIE_EN_ROOT);
$mtmp = [];
foreach ($moviecats as $mcat) {
	$mtmp[$mcat['id']] = $mcat;
}
$category = Category::MOVIE_EN_ROOT;
...
$page->smarty->assign('pagerquerybase', WWW_TOP . "/movies_en?t=" . $category . $browseby_link . "&amp;ob=" . $orderby . "&amp;offset=");
...
foreach ($ordering as $ordertype) {
	$page->smarty->assign('orderby' . $ordertype, WWW_TOP . "/movies_en?t=" . $category . $browseby_link . "&amp;ob=" . $ordertype . "&amp;offset=0");
}
