...
{if $release.upload_user}
<tr>
	<th style="vertical-align:top">NZB Poster:</th>
	<td>
		<a href="{$smarty.const.WWW_TOP}/uploads?name={$release.username|escape:"htmlall"}">{$release.username|escape:"htmlall"}</a>
	</td>
</tr>
{/if}
{if $release.password}
